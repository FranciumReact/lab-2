...
@Composable
fun CityListScreen(
    // cities: List<String> is the list of city names
    // this screen recieves from MainActivity
    cities: List<String>,
    // onAddCity: (String) -> Unit means that CityListScreen receives a function as a
    // parameter
    onAddCity: (String) -> Unit,
    onDeleteCity: (String) -> Unit,
    // modifier: Modifier = modifier allows layout info to be passed onto screen
...
class CityRepository {
    // Keeps the mutable app data private so it cant be changed by other classes
    ...
    // Gets a read only list for the UI to display
